...
class WebLandingPage extends StatefulWidget{
  ...
  static const routeName = "/WebLandingPage";
                          ...
                          SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  constraints: BoxConstraints(maxWidth: media.width*0.4),
                                  child: Hero(tag: 'img_logo',
                                  child: Image.asset("images/img_logo.webp", width: media.width * 0.5,)),
                                ),
                                SizedBox(height: media.height > 550 ? media.height*0.1 : media.height*0.07,),
                                // Padding(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          roundedButton(
                              title: "Sign Up", context: context, buttonWidth: buttonWidth, buttonHeight: media.height * 0.06,
                              onClicked: (){
                          ...
                          roundedButton(title: "Log In", context: context,
                              ...
                              buttonWidth: kIsWeb ? buttonWidth : media.width*0.65, buttonHeight: media.height * 0.06),
                          Expanded(
